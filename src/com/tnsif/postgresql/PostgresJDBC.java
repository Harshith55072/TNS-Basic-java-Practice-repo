...
public class PostgresJDBC {
    ...
    public static void main(String[] args) {
        ...
        String password = EnvConfig.getPassword(); // Read from .env (DB_PASSWORD) - never hardcoded here.

        // try-with-resources: This ensures the Connection object (conn) is automatically closed after usage,
        // which is good for resource management.
